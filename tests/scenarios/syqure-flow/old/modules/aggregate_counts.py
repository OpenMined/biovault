...
output_path = Path(os.environ.get("BV_OUTPUT_AGGREGATED", "aggregated_counts.json"))
...
for line in manifest_path.read_text(encoding="utf-8").splitlines():
    ...
    print(f"Loaded array from {datasite}: {arrays[-1]}")
...
output_path.write_text(json.dumps(totals) + "\n", encoding="utf-8")
